...
const fluxSystem = new k8s.core.v1.Namespace(
  'flux-system',
  {
    metadata: {
      labels: {
...
const alertsNotification = new k8s.apiextensions.v1.CustomResourceDefinition(
          ...
          schema: {
            openAPIV3Schema: {
              ...
              properties: {
                ...
                spec: {
                  description: 'AlertSpec defines an alerting rule'
                  + ' for events involving a list of objects',
                  properties: {
                    eventSeverity: {
                      default: 'info',
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          matchLabels: {
                            ...
                            + ' of matchExpressions, whose key field is \'key\', the operator is \'In\','
                    ...
                    exclusionList: {
                      description: 'A list of Golang regular expressions'
                    ...
                    suspend: {
                      ...
                      + ' subsequent events dispatching. Defaults to false.',
                      type: 'boolean',
                    },
                  },
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          observedGeneration: {
                            ...
                            + ' is currently 12, but the .status.conditions[x].observedGeneration is 9,'
                          ...
                          reason: {
                            ...
                            + ' condition last transition. Producers of specific condition types may define expected'
                            + ' values and meanings for this field, and whether the values are considered a guaranteed'
...
const bucketsSource = new k8s.apiextensions.v1.CustomResourceDefinition(
  'buckets.source.toolkit.fluxcd.io',
  {
    ...
    spec: {
      ...
      versions: [
        {
          additionalPrinterColumns: [
            { jsonPath: '.spec.endpoint', name: 'Endpoint', type: 'string' },
            {
              jsonPath: '.status.conditions[?(@.type==\'Ready\')].status',
              name: 'Ready',
              type: 'string',
              ...
              properties: {
                ...
                spec: {
                  ...
                  properties: {
                    accessFrom: {
                      ...
                      properties: {
                        namespaceSelectors: {
                          ...
                          + ' ACL applies. Items in this list are evaluated using a logical OR operation.',
                          items: {
                    ...
                    bucketName: { description: 'The bucket name.', type: 'string' },
                    endpoint: { description: 'The bucket endpoint address.', type: 'string' },
                    ignore: {
                    ...
                    region: { description: 'The bucket region.', type: 'string' },
                    secretRef: {
                      description: 'The name of the secret containing'
                      + ' authentication credentials for the Bucket.',
                      properties: {
                        name: { description: 'Name of the referent.', type: 'string' },
                      },
                      required: ['name'],
                    ...
                    suspend: {
                      description: 'This flag tells the controller to'
                      + ' suspend the reconciliation of this source.',
                      type: 'boolean',
                    },
                    timeout: {
                      default: '60s',
                ...
                status: {
                  ...
                  properties: {
                    artifact: {
                      description: 'Artifact represents the output of'
                      + ' the last successful Bucket sync.',
                      properties: {
                        checksum: {
                        ...
                        revision: {
                          ...
                          + ' the origin source system. It can be a Git commit SHA, Git tag,'
                          + ' a Helm index timestamp, a Helm chart version, etc.',
                          type: 'string',
                        },
                        url: {
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          reason: {
                            ...
                            + ' and whether the values are considered a guaranteed API. The value should'
                    ...
                    lastHandledReconcileAt: {
                      ...
                      + 'request value, so a change of the annotation value can be detected.',
                      type: 'string',
                    },
                    observedGeneration: {
                      description: 'ObservedGeneration is the last observed generation.',
                    ...
                    url: {
                      description: 'URL is the download link for the artifact'
                      + ' output of the last Bucket sync.',
                      type: 'string',
                    },
                  },
                  type: 'object',
          ...
          schema: {
            openAPIV3Schema: {
              ...
              properties: {
                ...
                metadata: { type: 'object' },
                spec: {
                  description: 'BucketSpec specifies the required configuration'
                  + ' to produce an Artifact for an object storage bucket.',
                  properties: {
                    accessFrom: {
                      ...
                      properties: {
                        namespaceSelectors: {
                          description: 'NamespaceSelectors is the list of namespace selectors to which'
                          + ' this ACL applies. Items in this list are evaluated using a logical OR operation.',
                          items: {
                            description: 'NamespaceSelector selects the namespaces to which this ACL applies.'
                            + ' An empty map of MatchLabels matches all namespaces in a cluster.',
                            properties: {
                    ...
                    ignore: {
                      ...
                      + ' format (which is the same as .gitignore). If not provided, a default will be'
                      + ' used, consult the documentation for your version to find out what those are.',
                      type: 'string',
                    },
                    insecure: {
                    ...
                    suspend: {
                      description: 'Suspend tells the controller to suspend'
                      + ' the reconciliation of this Bucket.',
                      type: 'boolean',
                    },
                    timeout: {
                      default: '60s',
                ...
                status: {
                  ...
                  properties: {
                    artifact: {
                      ...
                      properties: {
                        ...
                        revision: {
                          ...
                          + ' source system. It can be a Git commit SHA, Git tag, a Helm chart version, etc.',
                          type: 'string',
                        },
                        size: {
                        ...
                        url: {
                          ...
                          + ' controller managing the Source. It can be used to retrieve the Artifact'
                          + ' for consumption, e.g. by another controller applying the Artifact contents.',
                          type: 'string',
                        },
                      },
                      required: ['path', 'url'],
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          reason: {
                            ...
                            + ' whether the values are considered a guaranteed API. The value '
                    ...
                    observedGeneration: {
                      description: 'ObservedGeneration is the last observed'
                      + ' generation of the Bucket object.',
                      format: 'int64',
                      type: 'integer',
                    },
                    url: {
                      description: 'URL is the dynamic fetch link for the latest Artifact.'
                      + ' It is provided on a \'best effort\' basis, and using the'
                      + ' precise BucketStatus.Artifact data is recommended.',
                      type: 'string',
                    },
                  },
                  type: 'object',
...
const gitRepositories = new k8s.apiextensions.v1.CustomResourceDefinition(
  'gitrepositories.source.toolkit.fluxcd.io',
  {
    ...
    spec: {
      ...
      versions: [
        {
          additionalPrinterColumns: [
            { jsonPath: '.spec.url', name: 'URL', type: 'string' },
            {
              jsonPath: '.status.conditions[?(@.type==\'Ready\')].status',
              name: 'Ready',
              type: 'string',
              ...
              properties: {
                ...
                spec: {
                  ...
                  properties: {
                    ...
                    include: {
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          toPath: {
                            description: 'The path to copy contents to,'
                            + ' defaults to the name of the source ref.',
                            type: 'string',
                          },
                        },
                        required: ['repository'],
                    ...
                    ref: {
                      description: 'The Git reference to checkout and '
                      ...
                      properties: {
                        ...
                        commit: {
                          ...
                          + ' if specified Tag filters will be ignored.',
                          type: 'string',
                        },
                        semver: {
                    ...
                    timeout: {
                      default: '60s',
                      description: 'The timeout for remote Git operations'
                      + ' like cloning, defaults to 60s.',
                      type: 'string',
                    },
                    url: {
                    ...
                    verify: {
                      ...
                      properties: {
                        mode: {
                          description: 'Mode describes what git object '
                          + ' should be verified, currently (\'head\').',
                          enum: ['head'],
                          type: 'string',
                        },
                        secretRef: {
                          description: 'The secret name containing the public'
                          + ' keys of all trusted Git authors.',
                          properties: {
                            name: { description: 'Name of the referent.', type: 'string' },
                          },
                          required: ['name'],
                ...
                status: {
                  ...
                  properties: {
                    ...
                    includedArtifacts: {
                      description: 'IncludedArtifacts represents the included '
                      + ' artifacts from the last successful repository sync.',
                      items: {
                        ...
                        properties: {
                          ...
                          lastUpdateTime: {
                            description: 'LastUpdateTime is the timestamp'
                            + ' corresponding to the last update of this artifact.',
                            format: 'date-time',
                            type: 'string',
                          },
                          path: {
